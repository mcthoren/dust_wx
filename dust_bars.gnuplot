...
set format y "%.1f"
set format y2 "%.1f"
set term svg size 2000, 700 font ",12" background '0xffffff'
...
set output "~/dust/plots/pm_2.5_day_avgs.svg"
...
set output "~/dust/plots/pm_2.5_day_avgs.30.svg"
...
set output "~/dust/plots/pm_10_day_avgs.svg"
...
set title "Average Daily Dust Levels for the Last 30 Days"
set output "~/dust/plots/pm_10_day_avgs.30.svg"
